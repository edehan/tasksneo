		...
		"create_task",
		{
			...
			inputSchema: {
				...
				title: z
					.string()
					.optional()
					.describe("Task title (defaults to 'Untitled Draft')"),
				description: z
					.string()
					.optional()
				...
				allowLateSubmission: z
					.boolean()
					.optional()
					.describe("Whether to allow late submissions (default: true)"),
			},
			annotations: {
				readOnlyHint: false,
				destructiveHint: false,
		...
		"update_task",
		{
			...
			inputSchema: {
				...
				description: z
					...
					.nullable()
					.optional()
					.describe("New description (Markdown). Set null to clear."),
				dueAt: z
					.string()
					.nullable()
					.optional()
					.describe("New due date in ISO 8601 format. Set null to clear."),
				startAt: z
					.string()
					.nullable()
					.optional()
					.describe("New start date in ISO 8601. Set null to clear."),
				allowLateSubmission: z
					.boolean()
					.optional()
					.describe("Whether to allow late submissions"),
			},
			annotations: {
				readOnlyHint: false,
				destructiveHint: false,
